...
# api-schema-builder
[![NPM](https://nodei.co/npm/api-schema-builder.png)](https://nodei.co/npm/express-ajv-swagger-validation/)

[![NPM](https://nodei.co/npm-dl/express-ajv-swagger-validation.png?height=3)](https://nodei.co/npm/api-schema-builder/)

[![Join the chat at https://gitter.im/Zooz/api-schema-builder](https://badges.gitter.im/Zooz/api-schema-builder.svg)](https://gitter.im/Zooz/api-schema-builder?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
- [API](#api)
  ...
  - [api-schema-builder.getSchema(PathToSwaggerFile, options)](#express-ajv-swagger-validationgetSchemapathtoswaggerfile-options)
    - [Arguments](#arguments)
      - [Options](#options)
...
### api-schema-builder.getSchema(PathToSwaggerFile, options)

getSchema  the middleware with the swagger definition.
